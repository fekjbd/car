...
CREATE TABLE rx_laptop_pic(
  ...
  rid INT,                    #所属商品编号
  FOREIGN KEY(rid) REFERENCES rx_laptop(rid)    #外键约束，指向热销商品表中的rid
);
...
CREATE TABLE dog_laptop_pic(
  ...
  lg VARCHAR(128),            #大图片路径
  did INT,                    #所属商品编号
  FOREIGN KEY(did) REFERENCES dog_laptop(did)    #外键约束，指向狗狗商品表中的did
);
...
CREATE TABLE cat_laptop_pic(
  ...
  lg VARCHAR(128),             #大图片路径
  cid INT,                    #所属商品编号
  FOREIGN KEY(cid) REFERENCES cat_laptop(cid)    #指向猫咪商品表中的cid
);
...
CREATE TABLE xc_laptop_pic(
  ...
  lg VARCHAR(128),             #大图片路径
  xid INT,                    #所属商品编号
  FOREIGN KEY(xid) REFERENCES xc_laptop(xid)    #指向小宠商品表中的xid
);
...
CREATE TABLE sz_laptop_pic(
  ...
  lg VARCHAR(128),             #大图片路径
  sid INT,                    #所属商品编号
  FOREIGN KEY(sid) REFERENCES sz_laptop(sid)    #指向水族商品表中的sid
);
...
CREATE TABLE pc_laptop_pic(
  ...
  lg VARCHAR(128),             #大图片路径
  hid INT,                    #所属商品编号
  FOREIGN KEY(hid) REFERENCES pc_laptop(hid)    #指向爬虫商品表中的hid
);
